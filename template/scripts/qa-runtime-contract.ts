...
export const PRODUCTION_FORBIDDEN_ENV_KEYS = [
  "JEOMWON_DEMO_RESET",
  "JEOMWON_QA_APP_READY_TIMEOUT_MS",
  "JEOMWON_QA_ARTIFACT_DIR",
  "JEOMWON_QA_BASE_URL",
  "JEOMWON_QA_BOOKING_FIXTURE",
  "JEOMWON_QA_BROWSER",
  "JEOMWON_QA_CUSTOMER_STORAGE_STATE",
  "JEOMWON_QA_EMAIL_CAPTURE_DIR",
  "JEOMWON_QA_NO_SHOW_FIXTURE",
  "JEOMWON_QA_OPERATOR_EMAIL",
  "JEOMWON_QA_OPERATOR_STORAGE_STATE",
  "JEOMWON_QA_PORT",
  "JEOMWON_QA_READY_NONCE",
  "JEOMWON_QA_RESET",
