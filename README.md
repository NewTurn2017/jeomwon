...
| `skill/` | The Claude Code skill: `SKILL.md` fast path, `REFERENCE.md` methodology, `EXAMPLES.md` domain packs (salon, PC café, library, pension, generic), `scripts/{scaffold,inject,verify}.mjs` |
